...
Nota que acabamos de reemplazar el objeto `penguins_data` con la nueva versión.
...
> Del objeto `penguins_data`, agrupa los datos por la variable `species`, y resume los datos usando el el número de elementos por categoría (`n()`).
...
2.  Pidele a ChatGPT que te muestre como generar una gráfica de circular (o de *pastel*) usando **ggplot2** o **plotly** en R.
